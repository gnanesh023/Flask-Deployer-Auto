...
# === Config ===
NEW_USER="${NEW_USER:-cheesypc}"
NEW_USER_PASSWORD="${NEW_USER_PASSWORD:-Bagubali123@}"
MYSQL_ROOT_PASSWORD="${MYSQL_ROOT_PASSWORD:-Bagubali123@}"
CREATE_DATABASE="${CREATE_DATABASE:-true}"
DATABASE_NAME="${DATABASE_NAME:-pokkisham}"
DOMAIN_NAME="${DOMAIN_NAME:-cheesypc.com}"
FLASK_APP_NAME="app"
